<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="ReporteResumenHojas.aspx.cs" Inherits="ReporteResumenHojas" Title="Untitled Page" %>
...
<script type="text/javascript" language="javascript">
        ...
        <tr>
            <td align="center" style="width: 241px">
                <asp:Label ID="lblEncabezadoS" runat="server" BorderColor="Black" BorderStyle="Solid"
                    ...
                    Text="INFORME POR PERIODO (HISTORICO)" Width="368px"></asp:Label></td>
        </tr>
    </table>
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
<asp:UpdateProgress id="UpdateProgress1" runat="server" __designer:wfdid="w1"><ProgressTemplate>
<DIV class="progress"><IMG src="images/indicator.gif" />&nbsp;<asp:Label id="Label8" runat="server" Text="Generando Reporte..." Font-Bold="True" __designer:wfdid="w2"></asp:Label> </DIV>
</ProgressTemplate>
</asp:UpdateProgress>
 <TABLE style="BORDER-RIGHT: black thin solid; BORDER-TOP: black thin solid; BORDER-LEFT: black thin solid; BORDER-BOTTOM: black thin solid; BACKGROUND-COLOR: gainsboro" id="tblDetalleResumen" runat="server" visible="false"><TBODY><TR><TD style="WIDTH: 100px" align=right><asp:Label id="lblDescipcion" runat="server" ForeColor="Maroon" Width="106px" Text="Empresa:" Height="22px" Font-Bold="True" __designer:wfdid="w3"></asp:Label></TD><TD style="WIDTH: 100px" align=left><asp:Label id="lblEmpresa" runat="server" ForeColor="LightCoral" Width="106px" Height="22px" Font-Bold="True" __designer:wfdid="w4"></asp:Label></TD></TR><TR><TD style="WIDTH: 100px" align=right><asp:Label id="Label2" runat="server" ForeColor="Maroon" Width="106px" Text="Nro Contrato:" Height="24px" Font-Bold="True" __designer:wfdid="w5"></asp:Label></TD><TD style="WIDTH: 100px" align=left><asp:Label id="lblNroCont" runat="server" ForeColor="LightCoral" Width="106px" Height="22px" Font-Bold="True" __designer:wfdid="w6"></asp:Label></TD></TR><TR><TD style="WIDTH: 100px" align=right><asp:Label id="Label6" runat="server" ForeColor="Maroon" Width="106px" Text="Período:" Height="22px" Font-Bold="True" __designer:wfdid="w7"></asp:Label></TD><TD style="WIDTH: 100px" align=left><asp:Label id="lblPeriodo" runat="server" ForeColor="LightCoral" Width="106px" Height="22px" Font-Bold="True" __designer:wfdid="w8"></asp:Label></TD></TR><TR><TD style="WIDTH: 100px" align=right><asp:Label id="Label7" runat="server" ForeColor="Maroon" Width="106px" Text="Informe:" Height="24px" Font-Bold="True" __designer:wfdid="w9"></asp:Label></TD><TD style="WIDTH: 100px; BACKGROUND-COLOR: gainsboro" align=left>&nbsp;<IMG style="CURSOR: hand" id="imgReporte" onclick="AbrirDocumento()" height=35 src="images/AcrobatReader.png" width=32 name="imgReporte" runat="server" /></TD></TR></TBODY></TABLE>&nbsp;&nbsp;&nbsp; 
