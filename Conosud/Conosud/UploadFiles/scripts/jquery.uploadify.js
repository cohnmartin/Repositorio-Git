...
var flashVer = -1; if (navigator.plugins != null && navigator.plugins.length > 0) {
    ...
    //debugger;
    //if ($.browser.msie) {
    if ((navigator.appName == 'Microsoft Internet Explorer' && navigator.userAgent.match(/msie/i))) {
        var version; var axo; var e; try {
            axo = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.7");
            version = axo.GetVariable("$version")
        } catch (e) {
            alert("Usteden no tiene instalado Adoble Flash Player, por favor descargue e instale el componente para poder continuar.");
        }
        flashVer = version.replace("WIN ", "").replace(",", ".")
    }
} flashVer = flashVer.split(".")[0]; if (jQuery) {
    (function (a) {
